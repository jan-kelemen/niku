...
#define DISABLE_WARNING_PESSIMIZING_MOVE
...
#define DISABLE_WARNING_NRVO DISABLE_WARNING(-Wnrvo)
...
#define DISABLE_WARNING_PESSIMIZING_MOVE DISABLE_WARNING(-Wpessimizing-move)
